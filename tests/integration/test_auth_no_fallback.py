...
def test_user_with_tokens():
    ...
    return {
        ...
        "refresh_token": login_data_response.get("refresh_token") or login_response.cookies.get("refresh_token"),
...
def test_no_fallback_with_expired_access_token(test_user_with_tokens):
    """
...
def test_refresh_token_from_cookie_only(test_user_with_tokens):
    """
...
def test_refresh_token_missing_both_body_and_cookie():
    """
