...
def test_create_logic_challenge_with_adapted_enums(
    db_session: Session, logic_challenge_data
):
    """
...
def test_complex_query_with_enum_filters(
    db_session: Session, logic_challenge_data, db_enum_values
):
    """
    ...
    challenge2_data["challenge_type"] = get_enum_value(
