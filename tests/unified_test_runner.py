...
def main():
    ...
    parser = argparse.ArgumentParser(description="Exécuteur de tests unifié pour Mathakine")
    
    # Options pour les catégories de tests
    test_group = parser.add_argument_group("Catégories de tests")
    test_group.add_argument("--all", action="store_true", help="Exécuter tous les tests")
    test_group.add_argument("--unit", action="store_true", help="Exécuter les tests unitaires")
    test_group.add_argument("--api", action="store_true", help="Exécuter les tests d'API")
    test_group.add_argument("--integration", action="store_true", help="Exécuter les tests d'intégration")
    test_group.add_argument("--functional", action="store_true", help="Exécuter les tests fonctionnels")
    test_group.add_argument("--specific", type=str, help="Exécuter un test ou module spécifique")
    ...
    behavior_group.add_argument("--fix-enums", action="store_true", help="Corriger les problèmes d'énumération avant les tests")
    behavior_group.add_argument("--fast", action="store_true", help="Mode rapide (ignorer les tests lents)")
    behavior_group.add_argument("--skip-postgres", action="store_true", help="Ignorer les tests spécifiques à PostgreSQL")
    
    # Options de rapport
    report_group = parser.add_argument_group("Options de rapport")
    report_group.add_argument("--no-coverage", action="store_true", help="Désactiver le rapport de couverture")
    report_group.add_argument("--html-report", action="store_true", help="Générer un rapport HTML détaillé")
    report_group.add_argument("--xml-report", action="store_true", help="Générer un rapport XML pour CI/CD")
