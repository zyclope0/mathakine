...
def get_routes() -> List:
    ...
    return [
        ...
        Route(
            "/api/auth/validate-token", endpoint=api_validate_token, methods=["POST"]
        ),
        Route("/api/auth/refresh", endpoint=api_refresh_token, methods=["POST"]),
        Route("/api/auth/logout", endpoint=api_logout, methods=["POST"]),
        Route(
            "/api/auth/forgot-password", endpoint=api_forgot_password, methods=["POST"]
        ),
        Route(
            "/api/auth/reset-password", endpoint=api_reset_password, methods=["POST"]
        ),
        ...
        Route(
            "/api/users/me/password", endpoint=update_user_password_me, methods=["PUT"]
        ),
        ...
        Route(
            "/api/users/leaderboard", endpoint=get_users_leaderboard, methods=["GET"]
        ),
        ...
        Route(
            "/api/exercises/stats", endpoint=get_exercises_stats, methods=["GET"]
        ),  # Statistiques Holocron
        Route(
            "/api/exercises/{exercise_id:int}", endpoint=get_exercise, methods=["GET"]
        ),
        Route("/api/exercises/generate", endpoint=generate_exercise, methods=["GET"]),
        Route(
            "/api/exercises/generate", endpoint=generate_exercise_api, methods=["POST"]
        ),
        Route(
        ...
        Route(
            "/api/badges/stats", endpoint=get_user_gamification_stats, methods=["GET"]
        ),
        ...
        Mount(
            ...
            routes=[
                ...
                Route(
                    "/badges/{badge_id:int}", endpoint=admin_badge_get, methods=["GET"]
                ),
                Route(
                    "/badges/{badge_id:int}", endpoint=admin_badges_put, methods=["PUT"]
                ),
                Route(
                    "/badges/{badge_id:int}",
