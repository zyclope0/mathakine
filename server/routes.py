...
async def logic_challenge_page_temp(request):
    ...
    try:
        ...
        return render_template("logic-challenge.html", request, {
            "current_user": current_user,
            "challenge": challenge
        })
        ...
        return render_error(
            ...
            message="Impossible de charger ce défi logique.",
            status_code=500
        )
...
def get_routes() -> List:
    ...
    return [
        ...
        Route("/challenges", endpoint=hybrid_challenges_page),
        ...
        Route("/challenges-hybrid", endpoint=hybrid_challenges_page),
