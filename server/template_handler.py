...
def render_template(
    template_name: str, request: Request, context: dict = None, status_code: int = 200
) -> HTMLResponse:
    """
    ...
    try:
        ...
        return templates.TemplateResponse(
            template_name, context=context, status_code=status_code
        )
...
def render_error(
    request: Request, error: str, message: str = None, status_code: int = 500
) -> HTMLResponse:
    """
