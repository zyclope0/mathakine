...
def create_test_attempts(db: Session):
    ...
    db.add_all(attempts)
    db.flush()
    logger.info(f"{len(attempts)} tentatives créées")
...
def create_test_logic_challenges(db: Session):
    ...
    logic_challenges = [
        LogicChallenge(
            ...
            correct_answer="49",
            solution_explanation="Ce sont les carrés des nombres entiers : 1², 2², 3², 4², 5², 6², 7²",
        ...
        LogicChallenge(
            ...
            correct_answer="12",
            solution_explanation="Le maître peut construire 3 + 4 + 5 = 12 sabres différents, un pour chaque cristal disponible.",
        ...
        LogicChallenge(
            ...
            description="Pour accéder à l'archive Jedi, un code est nécessaire. Tu sais que :\n"
                        ...
                        "Quel est ce code ?",
            correct_answer="841",
            solution_explanation="Si on note le code abc, on a a = 2c et a + b + c = 13. En remplaçant a par 2c, on obtient "
                        "2c + b + c = 13, donc 3c + b = 13. En testant les valeurs possibles, on trouve c = 1, b = 4 et a = 8.",
