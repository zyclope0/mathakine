...
from app.models.diagnostic_result import (  # noqa: F401 — requis pour Base.metadata.create_all
    DiagnosticResult,
)
...
def create_test_exercises(db: Session):
    ...
    exercises = [
        Exercise(
            ...
            age_group=AgeGroup.GROUP_6_8.value,
        ...
        Exercise(
            ...
            age_group=AgeGroup.GROUP_13_15.value,
