...
def create_challenge(
    ...
    logger.info("Challenge créé: {} - {}", challenge.id, challenge.title)
    return challenge
...
def update_challenge(
    ...
    logger.info("Challenge mis à jour: {}", challenge.id)
    return challenge
...
def delete_challenge(db: Session, challenge_id: int) -> bool:
    ...
    logger.info("Challenge supprimé (soft): {}", challenge.id)
    return True
...
def record_attempt(
    ...
    logger.info(
        "Tentative enregistrée: Challenge {}, User {}, Correct: {}",
        challenge_id,
        user_id,
        is_correct,
    )
