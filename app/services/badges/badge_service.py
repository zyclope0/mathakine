...
from app.services.badges.badge_award_service import BadgeAwardService
from app.services.badges.badge_progress_service import (
    get_badges_progress as _get_badges_progress,
)
from app.services.badges.badge_progress_service import (
    get_closest_progress_notification as _get_closest_progress_notification,
)
from app.services.badges.badge_rarity_service import (
    get_badges_rarity_stats as _get_rarity,
)
...
from app.services.badges.badge_user_view_service import (
    get_user_badges as _get_user_badges,
)
from app.services.badges.badge_user_view_service import (
    get_user_gamification_stats as _get_user_gamification_stats,
)
from app.services.badges.badge_user_view_service import (
    set_pinned_badges as _set_pinned_badges,
)
