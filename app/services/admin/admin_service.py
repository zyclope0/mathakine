...
Les handlers importent depuis `app.services.admin.admin_application_service`,
`app.services.admin.admin_read_service`, etc.

Phase 3, item 3.3 — audit architecture 03/2026.
"""

from app.services.admin.admin_config_service import AdminConfigService  # noqa: F401
from app.services.admin.admin_content_service import AdminContentService  # noqa: F401
from app.services.admin.admin_helpers import CONFIG_SCHEMA  # noqa: F401
from app.services.admin.admin_stats_service import AdminStatsService  # noqa: F401
from app.services.admin.admin_user_service import AdminUserService  # noqa: F401
