...
def get_all_enum_values(db: Optional[Session] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        "challenge_types": {
            ...
            "deduction": get_enum_value(
                LogicChallengeType, LogicChallengeType.DEDUCTION
            ),
            "spatial": get_enum_value(
                LogicChallengeType, LogicChallengeType.VISUAL
            ),  # SPATIAL fusionné
            "probability": get_enum_value(
                LogicChallengeType, LogicChallengeType.PROBABILITY
            ),
