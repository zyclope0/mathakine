...
> **Référence** : [ROADMAP_FONCTIONNALITES](../02-FEATURES/ROADMAP_FONCTIONNALITES.md), [EVALUATION_PROJET_2026-02-07](EVALUATION_PROJET_2026-02-07.md)
...
- **Architecture** : séparation handlers / services / models, ~85 routes API
...
| Fonctionnalités détaillées | [ROADMAP_FONCTIONNALITES](../02-FEATURES/ROADMAP_FONCTIONNALITES.md) |
