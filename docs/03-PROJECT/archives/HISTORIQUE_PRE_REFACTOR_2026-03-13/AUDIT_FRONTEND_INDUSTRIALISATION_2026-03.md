...
**Statut :** ✅ TERMINÉ — Phases 0, 1, 2, 3, 4 terminées (P3.2 différé en backlog) (03/03/2026)
...
```typescript
challenge.tags && (Array.isArray(challenge.tags)
  ? challenge.tags.includes("ai")
  : challenge.tags === "ai" || challenge.tags.split(",").map(t => t.trim()).includes("ai"))
```
