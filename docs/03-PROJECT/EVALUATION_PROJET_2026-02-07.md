...
- ~80 routes API bien organisees par domaine
...
- `README_TECH.md` couvre architecture et ~80 routes API
...
| "Backend 100% API (37 routes)" | Mis a jour : ~80 routes API actuellement |
