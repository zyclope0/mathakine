...
- ~85 routes API bien organisees par domaine
...
- ~30 hooks custom, 3 stores Zustand
...
- `README_TECH.md` couvre architecture et ~85 routes API
...
| "Backend 100% API (37 routes)" | Mis a jour : ~85 routes API actuellement |
