...
- Prochain bump **ACTIF-04** : refaire d’abord une **mesure CI GitHub Actions** avec la famille **Vitest 4.1.4** avant tout ajustement de **`vitest.config.ts`** ; ne pas adopter les features **browser** ou **`experimental.*`** sans besoin produit/test explicite
