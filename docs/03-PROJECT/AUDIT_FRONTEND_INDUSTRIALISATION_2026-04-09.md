...
- ~~Prochain bump **ACTIF-04**~~ : **`ACTIF-04-COVERAGE-02`** effectué (2026-04-14) — seuils **46/38/42/48** depuis mesure CI 47.96/39.6/43.29/49.18 % ; prochain bump après nouveaux lots de tests et remesure CI
