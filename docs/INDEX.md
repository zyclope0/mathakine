...
3. [00-REFERENCE/README.md](00-REFERENCE/README.md)
4. [01-GUIDES/README.md](01-GUIDES/README.md)
5. [02-FEATURES/README.md](02-FEATURES/README.md)
6. [03-PROJECT/README.md](03-PROJECT/README.md)
7. [04-FRONTEND/README.md](04-FRONTEND/README.md)
8. [05-ADR/README.md](05-ADR/README.md)
...
- production operations entry point: [01-GUIDES/PRODUCTION_RUNBOOK.md](01-GUIDES/PRODUCTION_RUNBOOK.md)

> Historical baselines, closed iterations and archive-heavy reading now belong to [03-PROJECT/README.md](03-PROJECT/README.md), not to this global index.

## Folder Map

| Need                              | Document                                                                                                                                                                                                                                |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Beta fermée (parents / équipe)    | [BETA_GUIDE.md](BETA_GUIDE.md)                                                                                                                                                                                                          |
...
- `server/routes/` remains the truth for active HTTP routes
