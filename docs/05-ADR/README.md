...
| [ADR-002](ADR-002-chat-assistant-public-boundary.md) | Superseded                 | Historical record of the former public chat boundary, replaced by authenticated chat (`CHAT-AUTH-01`) |
