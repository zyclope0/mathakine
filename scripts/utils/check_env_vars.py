...
def main():
    ...
    print(f"  Variables documentées dans env.example: {color_text(len(documented_vars), Fore.GREEN)}")
    ...
    if all_non_compliant:
        ...
        print(f"\n{color_text('Toutes les variables d\'environnement sont conformes et documentées. 👍', Fore.GREEN)}")
        return 0
