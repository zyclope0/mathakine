...
def upgrade() -> None:
    ...
    op.execute("UPDATE users SET role = 'ARCHIVISTE'::userrole WHERE role::text = 'archiviste'")
    op.execute("UPDATE users SET role = 'GARDIEN'::userrole WHERE role::text = 'gardien'")
