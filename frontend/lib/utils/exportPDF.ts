 ...
 */
export function exportStatsToPDF(stats: UserStats, username: string, labels?: Partial<PDFExportLabels>): void {
  ...
  autoTable(doc, {
    ...
    body: [
      ...
      ...(stats.level && typeof stats.level === 'object' ? [[l.level, stats.level.current.toString()]] : []),
