...
export const CHALLENGE_TYPE_STYLES = {
  [CHALLENGE_TYPES.SEQUENCE]: { icon: ListOrdered, className: 'border-blue-400 dark:border-blue-600' },
  [CHALLENGE_TYPES.PATTERN]: { icon: Grid3X3, className: 'border-purple-400 dark:border-purple-600' },
  ...
  [CHALLENGE_TYPES.RIDDLE]: { icon: HelpCircle, className: 'border-yellow-400 dark:border-yellow-600' },
  [CHALLENGE_TYPES.DEDUCTION]: { icon: Search, className: 'border-red-400 dark:border-red-600' },
  [CHALLENGE_TYPES.PROBABILITY]: { icon: Percent, className: 'border-pink-400 dark:border-pink-600' },
  [CHALLENGE_TYPES.GRAPH]: { icon: GitBranch, className: 'border-indigo-400 dark:border-indigo-600' },
