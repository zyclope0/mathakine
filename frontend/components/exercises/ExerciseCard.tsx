    ...
    >
      ...
      <CardHeader>
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          <Badge 
            variant="outline" 
            className={`badge-sweep ${difficultyColor}`}
            aria-label={t('card.difficulty', { difficulty: difficultyDisplay })}
          >
            {difficultyDisplay}
          </Badge>
          <Badge 
      ...
      <CardContent>
        <div className="flex items-center justify-between text-sm text-muted-foreground mb-4">
          <div className="flex items-center gap-4" role="group" aria-label="Informations sur l'exercice">
