  ...
  try {
    ...
    try {
      ...
      if (
        ...
        return NextResponse.json({
          response: 'Désolé, le service d\'assistance mathématique n\'est pas disponible pour le moment. Veuillez réessayer plus tard ou consulter les exercices disponibles sur la plateforme !'
        });
      }
      ...
      return NextResponse.json({
        response: 'Une erreur est survenue lors de la communication avec l\'assistant. Veuillez réessayer.'
      });
    }
  } catch (error) {
