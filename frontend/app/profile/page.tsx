    ...
    return (
      <PageLayout>
        <EmptyState
          ...
          description={t('error.description', { default: 'Impossible de charger vos informations de profil.' })}
        />
      </PageLayout>
    );
  }
              ...
              {isEditingPersonalInfo ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    ...
                    <div>
                      <Label className="text-xs text-muted-foreground">{tPersonal('memberSince')}</Label>
            ...
            <CardContent className="space-y-4">
              {isEditingLearningPrefs ? (
                <>
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setLearningPrefs(prev => ({ ...prev, grade_level: value }))}
                      disabled={isUpdatingProfile}
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setLearningPrefs(prev => ({ ...prev, learning_style: value }))}
                      disabled={isUpdatingProfile}
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="kinesthésique">{t('learningStyles.kinesthésique')}</SelectItem>
                ...
                <div className="space-y-3">
                  <div>
                    <Label className="text-xs text-muted-foreground">{tLearning('gradeLevel')}</Label>
                    <p className="text-sm font-medium">{user.grade_level || '-'}</p>
                  </div>
                  <div>
                    <Label className="text-xs text-muted-foreground">{tLearning('learningStyle')}</Label>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {errors.current_password && (
                      <p id="current-password-error" className="text-sm text-destructive" role="alert" aria-live="polite">
                        {errors.current_password}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.new_password && (
                      <p id="new-password-error" className="text-sm text-destructive" role="alert" aria-live="polite">
                        {errors.new_password}
                      </p>
                    )}
                  </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-semibold">{stats.total_attempts || 0}</span>
                    </div>
                    <div className="flex justify-between items-center">
