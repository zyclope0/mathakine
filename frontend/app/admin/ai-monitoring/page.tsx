          ...
          <Card>
            <CardContent className="py-12">
              <p className="text-center text-destructive">
                Erreur de chargement. Verifiez vos droits admin.
              </p>
            </CardContent>
          </Card>
        ) : isLoading ? (
                  ...
                  <CardContent>
                    {Object.keys(statsData?.daily_summary ?? {}).length === 0 ? (
                      ...
                      <ul className="space-y-1">
                        {Object.entries(statsData?.daily_summary ?? {}).map(
                          ([metricKey, totals]) => (
                ...
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Detail fin par cle interne: type de defi, type d&apos;exercice IA ou segment
                      du chat.
                    </p>
                  </CardHeader>
                  <CardContent>
                  ...
                  <CardContent className="py-12">
                    <div className="text-center text-muted-foreground">
                      ...
                      <p className="mt-1 text-sm">
                        Les donnees s&apos;accumulent au fil des appels chat, des exercices IA et
                        des defis IA.
                      </p>
                    </div>
                  </CardContent>
